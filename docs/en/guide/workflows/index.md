...
|----------|------------|-----------|
| [Paper talk](./paper-talk) | `paper-talk` template | You are presenting one paper or your accepted work. |
| [Thesis defense](./thesis-defense) | `thesis-defense` template | You need argument, evidence, limitations, Q&A, and appendix navigation. |
| [Literature review](./literature-review) | `reading-group` or `seminar` template | You compare papers, gaps, and research directions. |
